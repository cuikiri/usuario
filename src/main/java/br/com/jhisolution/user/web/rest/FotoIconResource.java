...
/**
 * REST controller for managing {@link br.com.jhisolution.user.domain.FotoIcon}.
 */
@RestController
@RequestMapping("/api")
public class FotoIconResource {
    ...
    public FotoIconResource(FotoIconService fotoIconService) {
    ...
    public ResponseEntity<FotoIcon> createFotoIcon(@Valid @RequestBody FotoIcon fotoIcon) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/foto-icons/" + result.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, result.getId().toString()))
            .body(result);
    }

    /**
     * {@code PUT  /foto-icons} : Updates an existing fotoIcon.
     *
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/foto-icons")
    public ResponseEntity<FotoIcon> updateFotoIcon(@Valid @RequestBody FotoIcon fotoIcon) throws URISyntaxException {
        log.debug("REST request to update FotoIcon : {}", fotoIcon);
        if (fotoIcon.getId() == null) {
    ...
    public ResponseEntity<List<FotoIcon>> getAllFotoIcons(Pageable pageable) {
